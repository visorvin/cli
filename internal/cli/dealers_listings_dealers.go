...
func newDealersListingsDealersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cmd.Flags().Changed("sort") {
				allowedSort := []string{"days_on_market", "-days_on_market", "price", "-price", "miles", "-miles", "msrp", "-msrp", "discount", "-discount", "distance", "newest", "oldest", "price_asc", "price_desc", "mileage_asc", "mileage_desc", "cheapest", "expensive", "lowest_msrp", "highest_msrp", "best_discount", "lowest_miles", "highest_miles"}
				validSort := false
			...
			path := "/v1/dealers/{dealer_id}/listings"
			path = replacePathParam(path, "dealer_id", args[0])
	...
	cmd.Flags().StringVar(&flagSort, "sort", "", "Sort order. Use field names with optional - for descending, for example price or -price. Defaults to days_on_market,... (one of: days_on_market, -days_on_market, price, -price, miles, -miles, msrp, -msrp, discount, -discount, distance, newest, oldest, price_asc, price_desc, mileage_asc, mileage_desc, cheapest, expensive, lowest_msrp, highest_msrp, best_discount, lowest_miles, highest_miles)")
