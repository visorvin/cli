...
var whichIndex = []whichEntry{
	...
	{Command: "dealers list", Description: "Returns public dealer summaries ordered by active listing count. Listing counts use VIN-level listing deduplication and ownership assignment, so they can differ from raw dealer feed counts. Use dealer_id, state, country, type, make, and q to narrow results.", Group: "dealers"},
